const FISH_DATABASE = {
  ...
  'Rivière Belaya': [
    ...
    { name: 'Perche', rate: 0.25, minW: 0.1, maxW: 3.0, trophyW: 1.6, blueTrophyW: 2.7, valuePerKg: 12 },
    { name: 'Aspe', rate: 0.18, minW: 1.0, maxW: 14.3, trophyW: 8.0, blueTrophyW: 13.0, valuePerKg: 28 },
    { name: 'Truite brune', rate: 0.12, minW: 0.3, maxW: 5.5, trophyW: 3.0, blueTrophyW: 5.0, valuePerKg: 32 },
    { name: 'Ombre', rate: 0.08, minW: 0.2, maxW: 6.0, trophyW: 3.2, blueTrophyW: 5.5, valuePerKg: 30 },
    { name: 'Brochet', rate: 0.045, minW: 1.0, maxW: 22.0, trophyW: 12.0, blueTrophyW: 20.0, valuePerKg: 22 },
    { name: 'Ombre arctique', rate: 0.02, minW: 0.2, maxW: 2.75, trophyW: 2.0, blueTrophyW: 2.5, valuePerKg: 34 },
    { name: 'Taïmen', rate: 0.005, minW: 2.0, maxW: 88.0, trophyW: 50.0, blueTrophyW: 80.0, valuePerKg: 85 }
  ],
  'Lac cuivré': [
    { name: 'Carassassin', rate: 0.20, minW: 0.2, maxW: 3.2, trophyW: 1.8, blueTrophyW: 2.9, valuePerKg: 14 },
    { name: 'F1', rate: 0.18, minW: 1.5, maxW: 4.4, trophyW: 3.0, blueTrophyW: 4.0, valuePerKg: 35 },
    { name: 'Tanche', rate: 0.15, minW: 0.5, maxW: 6.6, trophyW: 4.0, blueTrophyW: 6.0, valuePerKg: 22 },
    { name: 'C2 Super Freak', rate: 0.12, minW: 2.5, maxW: 44.0, trophyW: 30.0, blueTrophyW: 40.0, valuePerKg: 65 },
    { name: 'Carpe Miroir', rate: 0.08, minW: 2.8, maxW: 44.0, trophyW: 25.0, blueTrophyW: 40.0, valuePerKg: 45 },
    { name: 'Carpe Cuir', rate: 0.07, minW: 3.0, maxW: 49.5, trophyW: 30.0, blueTrophyW: 45.0, valuePerKg: 50 },
    { name: 'Carpe Dinks Miroir', rate: 0.04, minW: 1.0, maxW: 49.5, trophyW: 35.0, blueTrophyW: 45.0, valuePerKg: 28 },
    { name: 'Carpe Dinks Linéaire', rate: 0.04, minW: 1.0, maxW: 49.5, trophyW: 35.0, blueTrophyW: 45.0, valuePerKg: 28 },
    { name: 'Carpe Dinks Cuir', rate: 0.04, minW: 1.0, maxW: 49.5, trophyW: 35.0, blueTrophyW: 45.0, valuePerKg: 28 },
    { name: 'Tanche Kvolsdorfsky', rate: 0.03, minW: 0.8, maxW: 6.6, trophyW: 4.0, blueTrophyW: 6.0, valuePerKg: 40 },
    { name: 'Orenji ogon', rate: 0.015, minW: 2.0, maxW: 38.5, trophyW: 25.0, blueTrophyW: 35.0, valuePerKg: 95 },
    { name: 'Kohaku', rate: 0.015, minW: 2.0, maxW: 38.5, trophyW: 25.0, blueTrophyW: 35.0, valuePerKg: 95 },
    { name: 'Mameshibori Goshiki', rate: 0.005, minW: 2.0, maxW: 38.5, trophyW: 25.0, blueTrophyW: 35.0, valuePerKg: 150 },
    { name: 'Narumi asagi', rate: 0.005, minW: 2.0, maxW: 38.5, trophyW: 25.0, blueTrophyW: 35.0, valuePerKg: 150 },
    { name: 'Yotsushiro', rate: 0.005, minW: 2.0, maxW: 38.5, trophyW: 25.0, blueTrophyW: 35.0, valuePerKg: 150 },
    { name: 'Hi utsuri', rate: 0.005, minW: 2.0, maxW: 38.5, trophyW: 25.0, blueTrophyW: 35.0, valuePerKg: 150 }
  ],
  'Mer de Norvège': [
    { name: 'Lieu Noir', rate: 0.20, minW: 1.0, maxW: 27.5, trophyW: 19.0, blueTrophyW: 25.0, valuePerKg: 55 },
    { name: 'Chaboisseau', rate: 0.15, minW: 0.1, maxW: 4.4, trophyW: 3.0, blueTrophyW: 4.0, valuePerKg: 35 },
    { name: 'Brosme', rate: 0.14, minW: 1.0, maxW: 26.4, trophyW: 18.0, blueTrophyW: 24.0, valuePerKg: 48 },
    { name: 'Maquereau', rate: 0.12, minW: 0.2, maxW: 3.08, trophyW: 2.0, blueTrophyW: 2.8, valuePerKg: 40 },
    { name: 'Cabillaud', rate: 0.09, minW: 2.0, maxW: 71.5, trophyW: 50.0, blueTrophyW: 65.0, valuePerKg: 75 },
    { name: 'Aiglefin', rate: 0.08, minW: 0.5, maxW: 14.3, trophyW: 11.0, blueTrophyW: 13.0, valuePerKg: 65 },
    { name: 'Petit Sébaste', rate: 0.06, minW: 0.3, maxW: 4.4, trophyW: 3.0, blueTrophyW: 4.0, valuePerKg: 50 },
    { name: 'Grand Sébaste', rate: 0.05, minW: 0.8, maxW: 12.1, trophyW: 9.0, blueTrophyW: 11.0, valuePerKg: 60 },
    { name: 'Lieu Jaune', rate: 0.04, minW: 1.0, maxW: 15.4, trophyW: 11.0, blueTrophyW: 14.0, valuePerKg: 65 },
    { name: 'Sébaste de l\'Atlantique', rate: 0.03, minW: 0.5, maxW: 7.7, trophyW: 5.5, blueTrophyW: 7.0, valuePerKg: 70 },
    { name: 'Saumon des Dieux', rate: 0.015, minW: 5.0, maxW: 220.0, trophyW: 140.0, blueTrophyW: 200.0, valuePerKg: 180 },
    { name: 'Chimère Commune', rate: 0.01, minW: 1.0, maxW: 2.75, trophyW: 1.5, blueTrophyW: 2.5, valuePerKg: 190 },
    { name: 'Espadon', rate: 0.005, minW: 12.0, maxW: 495.0, trophyW: 300.0, blueTrophyW: 450.0, valuePerKg: 210 },
    { name: 'Thon rouge', rate: 0.003, minW: 15.0, maxW: 440.0, trophyW: 250.0, blueTrophyW: 400.0, valuePerKg: 250 },
    { name: 'Requin du Groenland', rate: 0.003, minW: 20.0, maxW: 990.0, trophyW: 600.0, blueTrophyW: 900.0, valuePerKg: 220 },
    { name: 'Requin-Taupe', rate: 0.002, minW: 10.0, maxW: 220.0, trophyW: 140.0, blueTrophyW: 200.0, valuePerKg: 240 },
    { name: 'Requin-lézard', rate: 0.001, minW: 2.0, maxW: 77.0, trophyW: 50.0, blueTrophyW: 70.0, valuePerKg: 280 },
    { name: 'Requin Pèlerin', rate: 0.0008, minW: 25.0, maxW: 2200.0, trophyW: 1500.0, blueTrophyW: 2000.0, valuePerKg: 350 },
    { name: 'Poisson Football de L\'Atlantique', rate: 0.0002, minW: 0.5, maxW: 9.35, trophyW: 7.0, blueTrophyW: 8.5, valuePerKg: 800 }
  ]
};
